...
const IgvVariantWithPromoter = ({
  ...
  let genecode_index_url =
    "https://s3.amazonaws.com/igv.org.genomes/hg38/Homo_sapiens.GRCh38.94.chr.gff3.gz.tbi";
  // let genecode_index_url = "/igv/gencode.v35.annotation.sort.gtf.gz.tbi";
  let rnaseq_url = `${
    import.meta.env.VITE_EXPRESS_URL
  }/public/igv/bigwig/${celltype}/${celltype}_rep1PE_stranded_genome_plusAll.bw`;
  ...
  if (celltype === "Osteocyte") {
    ...
    atac_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/ATAC_seq_Osteoblast_pvalue.bigwig`;
    dnase_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/DNase_seq_Osteoblast.bigWig`;
    chromHMM_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/imputed12marks_hg38lift_dense.bed`;
    H3k27ac_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/H3K27ac_Osteoblast_pvalue.bigWig`;
    H3k4me3_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/H3K4me3_Osteoblast_pvalue.bigWig`;
    H3k4me1_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/Osteoblast/H3K4me1_Osteoblast_pvalue.bigWig`;
    ...
    atac_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/ATAC_seq_${celltype}_pvalue.bigwig`;
    dnase_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/DNase_seq_${celltype}.bigWig`;
    chromHMM_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/imputed12marks_hg38lift_dense.bed`;
    H3k27ac_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/H3K27ac_${celltype}_pvalue.bigWig`;
    H3k4me3_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/H3K4me3_${celltype}_pvalue.bigWig`;
    H3k4me1_url = `${
      import.meta.env.VITE_EXPRESS_URL
    }/public/igv/bigwig/${celltype}/H3K4me1_${celltype}_pvalue.bigWig`;
  ...
  useEffect(() => {
    const bedpeUrl = `/igv/temp/${variant.RSID}_${celltype}.bedpe.txt`;
    const options = {
      genome: "hg38",
      locus: locus,
      roi: [
      ...
      tracks: [
        ...
        },
        {
          ...
          url: `${
            import.meta.env.VITE_EXPRESS_URL
          }/public/igv/encodeCcreCombined.bb`,
          height: 50,
          name: "ENCODE-cCRE",
          displayMode: "EXPANDED",
        },
  ...
  return (
    <div>
      <div
        ref={igvDiv}
        style={{ height: "500px", width: "100%", marginBottom: "700px" }}
      ></div>
    </div>
  );
};
